...
sanitydata %>% arrange(latestindex)
...
sanitycheck %>% dplyr::filter(is.na(indexdate))
sanitycheck %>% dplyr::filter(latestindex!=indexdate)
```
...
Is this the problem of missing data from the CPRD extract.

I can create a list of patients and re-extract
